    ...
    <div className="flex h-screen bg-gray-50 text-gray-900 overflow-hidden">
      ...
      <aside className="w-64 flex-shrink-0 border-r border-gray-200 bg-white flex flex-col hidden md:flex">
        ...
        <div className="p-4 border-t border-gray-200">
          <div className="mb-8 flex flex-col items-center justify-center opacity-90 transition-opacity">
            <div className="relative mb-3 flex flex-col items-center">
              <div className="bg-white text-gray-800 text-xs py-1.5 px-3 rounded-full shadow-lg border border-gray-100 font-bold z-10 whitespace-nowrap mb-2 relative animate-bounce-slow">
                管理お疲れ様です！☕️
            ...
            <p className="text-[10px] text-gray-400 font-bold tracking-widest uppercase mt-1 bg-white/80 px-3 py-0.5 rounded-full">
              Powered By Zono
            </p>
          </div>
          <button
            onClick={logout}
            className="flex items-center justify-center w-full px-4 py-2 text-sm text-red-500 hover:bg-red-50 rounded-md transition-colors font-medium"
          >
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <nav className="md:hidden flex h-16 border-t border-gray-200 bg-white">
          <button
            onClick={() => setActiveTab("dashboard")}
            className={`flex-1 flex flex-col items-center justify-center space-y-1 ${activeTab === "dashboard" ? "text-gray-900 font-medium" : "text-gray-500"}`}
          >
          ...
          <button
            onClick={() => setActiveTab("members")}
            className={`flex-1 flex flex-col items-center justify-center space-y-1 ${activeTab === "members" ? "text-gray-900 font-medium" : "text-gray-500"}`}
          >
